...
## Do
- [ ] First **low-speed drive in a safe, private area**; watch voltage/current/temps.
- [ ] Tune pedal feel, regen, current limits in the VCU.
- [ ] Drive a real **5–15 mi grocery loop**; **log Wh/mi**.
- [ ] Sort brakes/suspension for the added weight; bed-in brakes.

## Done when
The 944 drives under its own power and completes a grocery loop. **Stage 1 done.** 🏁

## Refs
`../docs/mvp-mule.md` · `../docs/build-guide.md` §6B/6C · `../docs/range-analysis.md`
